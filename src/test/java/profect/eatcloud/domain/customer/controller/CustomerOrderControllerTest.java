...
class CustomerOrderControllerTest {
    ...
    void createOrder_success() {
        ...
        // when
        ResponseEntity<CustomerOrderResponse> response = customerOrderController.createOrder(userDetails, orderTypeCode, usePoints, pointsToUse);

        // then
        assertThat(response.getStatusCodeValue()).isEqualTo(200);
        assertThat(response.getBody()).isNotNull();
        assertThat(response.getBody().getOrderNumber()).isEqualTo("ORD-20250804-ABCDE");
    ...
    void getMyOrders() {
        ...
        // when
        ResponseEntity<List<Order>> response = customerOrderController.getMyOrders(userDetails);
    ...
    void getMyOrder() {
        ...
        // when
        ResponseEntity<Order> response = customerOrderController.getMyOrder(userDetails, orderId);
