...
public class PaymentController {
	...
	public ResponseEntity<Map<String, Object>> checkoutPage(@RequestParam("orderData") String orderDataJson) {
		...
		try {
			...
			if (usePoints != null && usePoints && pointsToUse != null && pointsToUse > 0
				&& authResult.getCustomer() != null) {
			...
			String tossOrderId =
				"TOSS_" + createdOrder.getOrderId().toString().replace("-", "").substring(0, 16).toUpperCase();
