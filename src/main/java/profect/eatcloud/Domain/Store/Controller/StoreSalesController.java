...
@Tag(name = "Store Sales Statistics", description = "가게 매출 통계 API")
public class StoreSalesController {
    ...
    public ResponseEntity<List<MenuSalesRankingResponseDto>> getMenuSalesRanking(
        ...
        UUID managerId = getManagerUuid(userDetails);
        List<MenuSalesRankingResponseDto> ranking = storeSalesService.getMenuSalesRanking(storeId, startDate, endDate, limit, managerId);
    ...
    public ResponseEntity<SalesPeriodSummaryResponseDto> getSalesSummary(
        ...
        UUID managerId = getManagerUuid(userDetails);
        SalesPeriodSummaryResponseDto summary = storeSalesService.getSalesSummary(storeId, startDate, endDate, managerId);
    ...
    public ResponseEntity<SalesStatisticsResponseDto> getSalesStatistics(
        ...
        UUID managerId = getManagerUuid(userDetails);
        SalesStatisticsResponseDto statistics = storeSalesService.getSalesStatistics(storeId, startDate, endDate, managerId);
