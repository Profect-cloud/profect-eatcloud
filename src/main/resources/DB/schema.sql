...
CREATE TYPE user_type_enum AS ENUM ('customer', 'manager', 'admin');
...
CREATE TABLE p_addresses (
    ...
    p_time_id    UUID NOT NULL,
    CONSTRAINT fk_p_addresses_user  FOREIGN KEY (user_id)   REFERENCES p_users(id),
...
CREATE TABLE p_cart (
    ...
    p_time_id UUID NOT NULL,
    CONSTRAINT fk_cart_user     FOREIGN KEY (user_id)    REFERENCES p_users(username),
...
CREATE TABLE p_payments (
    ...
    p_time_id           UUID NOT NULL,
    CONSTRAINT fk_payments_user    FOREIGN KEY (user_id)            REFERENCES p_users(username),
...
CREATE TABLE p_orders (
    ...
    p_time_id     UUID NOT NULL,
    CONSTRAINT fk_orders_user      FOREIGN KEY (user_id)     REFERENCES p_users(username),
